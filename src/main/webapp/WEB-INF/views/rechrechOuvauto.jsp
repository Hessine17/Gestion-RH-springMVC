...
<div class="row">
	...
	<center>		<h2>
Ajouter  une autorisation</h2></center>


			</div>
					<br>
				<br>
				 <form  action="rechrechOuvautoper" method="post" role="form" class="search-form-full" >
...
<div class="panel panel-primary">
			...
			<center>	<div class="panel-title">Resultat</div></center>
				...
				<tbody>
			<c:forEach items="${ouvrier}" var="fon">
					<tr>
				<td><img src="photoouv?id=${fon.id}" alt="" class="img-circle" width="44" /></td>
					...
					<td><a href="detailouvauto?id=${fon.id}">
					
						Détails
					
					</a></td>
					<td><a href="autorisationOuv?id=${fon.id}">

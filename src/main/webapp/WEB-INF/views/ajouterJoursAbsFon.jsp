...
%>
		 ...
		 <form  action="addjoursabsfon" method="post" enctype="multipart/form-data"  name="f" onsubmit=" return verif();">
...
<td></td>
<td><label class="control-label">Date de retour</label>
				<p id="erreurdate"></p>

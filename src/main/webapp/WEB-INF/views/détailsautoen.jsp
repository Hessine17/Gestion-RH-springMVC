...
<form action="détailautoen" method="get" name="f" onsubmit=" return verif();">
		<table>
				<col width="300px"/>
				<col width="90px"/>
				<col width="300px"/>
			<tr><td><label class="control-label">ID </label>
				...
				<input type="text" class="form-control" name="iden" data-validate="required,creditcard" readonly="readonly"  value="${enseignants.id}" /></td></tr>
		<tr><td>
		<label class="control-label">Nom </label>
				<p id="erreuridentificateur"></p>
				<input type="text" class="form-control"  data-validate="required,creditcard" readonly="readonly"   value="${enseignants.nom}" />
		</td><td></td>
		...
		<label class="control-label">Identificateur </label>
			...
			<input type="text" class="form-control"  data-validate="required,creditcard" readonly="readonly"   value="${enseignants.identificateur}" />
		</td>

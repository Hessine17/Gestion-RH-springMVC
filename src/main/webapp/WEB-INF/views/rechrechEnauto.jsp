...
<center>	<h2>Ajouter  autorisation</h2></center>


			</div>
					<br>
				<br>
				 <form  action="rechrechEnautoper" method="post" role="form" class="search-form-full" >
				 
				 <div class="col-md-9 col-sm-7">
		<h3>Recherche les Enseignants</h3>
	</div>
...
<div class="panel panel-primary">
			...
			<center>	<div class="panel-title">Resultat</div></center>
				...
				<tbody>
			<c:forEach items="${enseignants}" var="en">
					<tr>
				<td><img src="photoen?id=${en.id}" alt="" class="img-circle" width="44" /></td>
					<td>${en.nom}</td>
					<td>${en.prenom}</td>
					...
					<td><a href="detailenauto?id=${en.id}">
					
						Détails
					
					</a></td>
					<td><a href="autorisationEn?id=${en.id}">

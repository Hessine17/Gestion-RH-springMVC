...
<div class="row">
			...
			<div class="panel-heading"><br>
				<center><h2>
Ajouter  heures de retard</h2></center>
...
%>
					...
					<br>
				<br>
				 <form  action="rechrechOuvHeureAbsper" method="post" role="form" class="search-form-full" >
...
<div class="panel panel-primary">
			...
			<c:forEach items="${Ouvriers}" var="fon">
				...
				<td><img src="photoouv?id=${fon.id}" alt="" class="img-circle" width="44" /></td>
					...
					<td><a href="detailretaouv?id=${fon.id}">
					
						Détails
					
					</a></td>
					<td><a href="ajouterHeureAbsOuv?id=${fon.id}">

...
<center><h2>Ajouter jours d'absences</h2></center>
	<% String erreur=(String) request.getAttribute("erreur");
if (erreur!=null){
	out.print("<div class='col-md-6'><div class='alert alert-danger'>"+erreur+"</div></div>");
}
%>
		 ...
		 <form  action="addjoursabsouv" method="post" enctype="multipart/form-data"  name="f" onsubmit=" return verif();">
...
<td><label class="control-label">Id</label>
				...
				<input type="text" class="form-control" name="idouv" data-validate="required,creditcard"  value="${ouvrier.id }" readonly="readonly" /></td>
</tr>

<tr><td><label class="control-label">Identificateur</label>
				
				<input type="text" class="form-control" name="identificateur" data-validate="required,creditcard" value="${ouvrier.identificateur }" readonly="readonly" /></td>
<td></td>
<td><label class="control-label">Nom</label>
				
				<input type="text" class="form-control" name="nom" data-validate="required,creditcard"  value="${ouvrier.nom }" readonly="readonly" /></td>
</tr>

<tr>
<td><label class="control-label">Prenom </label>
				
				<input type="text" class="form-control" name="prenom" data-validate="required,creditcard" value="${ouvrier.prenom }" readonly="readonly" /></td>
<td></td>
<td><label class="control-label">Type </label>
				
				<input type="text" class="form-control" name="type3" data-validate="required,creditcard"  value="${ouvrier.type }" readonly="readonly"/></td>
</tr>
<tr>

<td><label class="control-label">Grade</label>
				
				<input type="text" class="form-control" name="grade" data-validate="required,creditcard" value="${ouvrier.grade }" readonly="readonly" /></td>
<td></td>

</tr>
<tr><td>
<label class="control-label">Type d'absence</label><input type="text" class="form-control" name="type" data-validate="required,creditcard"  value="Non justifier" readonly="readonly" /></td>
...
<td><label class="control-label">date *</label>
				<p id="erreurdate"></p>
				<input type="date" class="form-control" name="datededebut" data-validate="required,creditcard" value="${datedebut }"  /></td>
<td></td>
<td><label class="control-label">date de ret*</label>
				<p id="erreurdate"></p>
				<input type="date" class="form-control" name="datederetour" data-validate="required,creditcard" /></td>
			...
			<label class="control-label">prenom </label>
				...
				<input type="text" class="form-control" name="prenom" data-validate="required,creditcard" value="${ouvrier.prenom }" readonly="readonly" />
			</div>
				<div class="form-group">
			<label class="control-label">type </label>
				
				<input type="text" class="form-control" name="type3" data-validate="required,creditcard"  value="${ouvrier.type }" readonly="readonly"/>
			</div>
			...
			<label class="control-label">grade</label>
				...
				<input type="text" class="form-control" name="grade" data-validate="required,creditcard" value="${ouvrier.grade }" readonly="readonly" />
			</div>
		...
		<input type="text" class="form-control" name="type" data-validate="required,creditcard"  value="Non justifier" readonly="readonly" />

			<div class="form-group">
				<label class="control-label">date *</label>
				<p id="erreurdate"></p>
				<input type="date" class="form-control" name="datededebut" data-validate="required,creditcard"   value="${datedebut }" />
			</div>
			<div class="form-group">
				<label class="control-label">date de ret*</label>
				<p id="erreurdate"></p>
				<input type="date" class="form-control" name="datederetour" data-validate="required,creditcard" />
			</div> --%>
		<!--	<div class="form-group">
				...
				<thead>
					<tr>
						...
						<th>Date</th>
							...
							<c:forEach items="${joursabsouv}" var="joursabs"> 	
				<tbody>
				

					<tr>
	
					<td>${joursabs.identificateur}</td>
					<td>${joursabs.nom}</td>
					<td>${joursabs.prenom}</td>
				
					<td>${joursabs.datededebut}</td>

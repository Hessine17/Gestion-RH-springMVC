...
<div class="row">
			...
			<div class="panel-heading"><br>
				<center><h2>
Ajouter  jours d'absences</h2></center>


			</div>
					<br>
				<br>
				 <form  action="rechrechOuvJoursAbsper" method="post" role="form" class="search-form-full" >
...
<div class="panel panel-primary">
			...
			<c:forEach items="${ouvriers}" var="fon">
				...
				<td><img src="photoouv?id=${fon.id}" alt="" class="img-circle" width="44" /></td>
					...
					<td><a href="detailJourabsouv?id=${fon.id}">
					
						Détails
					
					</a></td>
					<td><a href="ajouterJoursAbsOuv?id=${fon.id}">

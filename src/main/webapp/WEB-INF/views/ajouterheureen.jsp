	...
	<div class="col-sm-8">
		...
		<div class="panel panel-primary">
			<div class="panel-heading"><br>
				<div class="panel-title">Gerer Les Fonctionnaires</div>
				...
				<form  action=addheureen method="post" enctype="multipart/form-data" >
...
<tr>
<td ><input name="iden" type="text"></td>
</tr>
<tr>
...
<tr>
<td>nbr des heures</td><td> <input name="nbrheure" type="number"></td>

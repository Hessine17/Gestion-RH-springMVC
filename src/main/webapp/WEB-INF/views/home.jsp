	...
	<ul class="dropdown-menu-list scroller">
		...
		<c:forEach items="${notifications}" var="notif">		<li class="unread notification-success">
			<a >
				...
				<span class="line">
					<strong>L'employé ${notif.nom } retourne aujorud'hui au travail </strong>
...
<p>	Vous avez ${titu} nouvelle(s) notification(s) de titularisation(s)</p>
</li>
	...
	<li class="notification-warning">
			<a >
				...
				<span class="line">
				C'est la date de titularisation du fonctionnnaire	"${ens.nom} "
				</span>
	...
	<li class="notification-warning">
			<a >
				...
				<span class="line">
				c'est la date de titularisation de l'ouvrier   "${ens.nom} "
				</span>
...
<%-- 			<script src="<%=request.getContextPath()%>/resources/assets/canvasjs.min.js"></script>
	...
	<center>
							<div id="chartContainer" style="height: 300px; width: 100%;"></div>		</center>

...
<div class="row">
			...
			<div class="panel-heading"><br>
				<center><h2>Ajouter jours d'absences</h2></center>
					...
					<br>
				<br>
				 <form  action="rechrechFonJoursAbsper" method="post" role="form" class="search-form-full" >
...
<div class="panel panel-primary">
			...
			<center>	<div class="panel-title">Resultat</div></center>
				...
				<tbody>
			<c:forEach items="${fonctionnaire}" var="fon">
					<tr>
				<td><img src="photofon?id=${fon.id}" alt="" class="img-circle" width="44" /></td>
					...
					<td><a href="detailJourabsfon?id=${fon.id}">
					
						Détails
					
					</a></td>
					
					<td><a href="ajouterJoursAbsFon?id=${fon.id}">

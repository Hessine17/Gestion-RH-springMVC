...
<div class="row">
	...
	/* 	if(document.f.nom.value==""){
		...
		return v;
				...
				<center><h2>Modifier les fonctionnaires</h2></center>
	
 <form  action="modfon" method="post" enctype="multipart/form-data" name="f" onsubmit=" return verif();">
	<div class="col-sm-8">
				...
				<input type="text" class="form-control" name="id" data-validate="required,creditcard"  value="${fonctionnaire.id }"  readonly="readonly"/></td><td></td>
				<td><label class="control-label">Identificateur *</label>
				<p id="erreuridentificateur"></p>
				<input type="text" class="form-control" name="identificateur" data-validate="required,creditcard"  value="${fonctionnaire.identificateur }"  readonly="readonly" /></td></tr>
		<tr>	<td><label class="control-label">Prenom </label>
				<p id="erreuridentificateur"></p>
				<input type="text" class="form-control" name="prenom" data-validate="required,creditcard" value="${fonctionnaire.prenom }" /></td>
<td></td>
				<td>	<label class="control-label">Nom *</label>
				<p id="erreurnom"> </p>
				<input type="text" class="form-control" name="nom" data-validate="required,creditcard" value="${fonctionnaire.nom }"/></td>
	<td></td><td><label class="control-label">Telephone </label>
				<p id="erreuridentificateur"></p>
				<input type="text" class="form-control" name="tel" data-validate="required,creditcard"  value="${fonctionnaire.tel }" /></td>			</tr>
				<tr>	<td><label class="control-label">Email</label>
				<p id="erreuridentificateur"></p>
				<input type="text" class="form-control" name="email" data-validate="required,creditcard" value="${fonctionnaire.email }"  /></td>
<td></td>
				<td>	<label class="control-label">Adresse </label>
				<p id="erreurnom"> </p>
				<input type="text" class="form-control" name="adresse" data-validate="required,creditcard" value="${fonctionnaire.adresse }" /></td>
				
		<td></td>		<td>	<label class="control-label">Photo</label>
					<img src="photofon?id=${fonctionnaire.id}">
				<input type="file" name="file"></td>
				</tr>
		<tr><td><label class="control-label">Heure d'entrée  </label>
				
				<input type="time" class="form-control" name="heureTravaildebut" data-validate="required,creditcard"   value ="${fonctionnaire.heureTravaildebut }"  />
			...
			<td><label class="control-label">Heure de sortie </label>
				...
				<input type="time" class="form-control" name="heureTravailfin" data-validate="required,creditcard"  value ="${fonctionnaire.heureTravailfin }"  /></td>
			</tr>		
		...
		changer type
				...
				<p id="erreurtype"> </p>
					...
					<select  name="type"class="form-control">
								<option></option>
								<option>Technicien en chef </option>
							
								<option>Technicien principal </option>
							<option>Technicien </option>
							<option> Adjoint technique</option>
		...
		changer type
			...
			<select  name="grade"class="form-control">
				...
				<input type="date" class="form-control" name="datereq" data-validate="required,creditcard"   value="${fonctionnaire.datereq }"/></td>
				</tr>
		...
		<center>
			...
			<button type="reset" class="btn">Effacer</button>
				...
				<input type="text" class="form-control" name="id" data-validate="required,creditcard"  value="${fonctionnaire.id }" readonly="readonly" />
			</div>
				<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="nom" data-validate="required,creditcard" value="${fonctionnaire.nom }"/>
			</div>
			<div class="form-group">
				<label class="control-label">Prenom</label>
				
				<input type="text" class="form-control" name="prenom" data-validate="required,creditcard" value="${fonctionnaire.prenom }" />
			</div>
			<div class="form-group">
				<label class="control-label">Telephone</label>
				
				<input type="text" class="form-control" name="tel" data-validate="required,creditcard" value="${fonctionnaire.tel }" />
			</div>
			<div class="form-group">
				<label class="control-label">Adresse</label>
				
				<input type="text" class="form-control" name="adresse" data-validate="required,creditcard" value="${fonctionnaire.adresse }"  />
			</div>
				<div class="form-group">
			<label class="control-label">Email</label>
				
				<input type="email" class="form-control" name="email" data-validate="required,creditcard" value="${fonctionnaire.email }" />
			</div>
			<div class="form-group">
			...
			<label class="control-label">heureTravailfin </label>
				...
				<input type="time" class="form-control" name="heureTravailfin" data-validate="required,creditcard" value="${fonctionnaire.heureTravaildebut }" />
			</div>
			...
			<label class="control-label">Horaire  De Travail</label>
				...
				<input type="text" class="form-control" name="heureTravail" data-validate="required,creditcard" value="${fonctionnaire.heureTravail }" />
			</div>
			<div class="form-group">
		...
		changer type
			...
			<label class="control-label">Date de recrutement</label>
				...
				<input type="date" class="form-control" name="datereq" data-validate="required,creditcard"  value="${fonctionnaire.datereq }"/>
			</div>
			<img src="photofon?id=${fonctionnaire.id}">

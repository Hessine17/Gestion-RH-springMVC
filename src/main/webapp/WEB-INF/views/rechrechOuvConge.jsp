...
<div class="row">
		...
		<center><h2>
Ajouter  congé</h2></center>


			</div>
					<br>
				<br>
				 <form  action="rechrechOuvCongeper" method="post" role="form" class="search-form-full" >
...
<div class="panel panel-primary">
			...
			<c:forEach items="${ouvriers}" var="fon">
				...
				<td><img src="photoouv?id=${fon.id}" alt="" class="img-circle" width="44" /></td>
					...
					<td><a href="detailouv?id=${fon.id}">
					
						Détails
					
					</a></td>
					<td><a href="autorisationOuvConge?id=${fon.id}">

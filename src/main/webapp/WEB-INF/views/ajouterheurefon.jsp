...
%>
	...
	<div class="col-sm-8">
		...
		<div class="panel panel-primary">
				...
				<form  action=addheure method="post" enctype="multipart/form-data"  name="f" onsubmit=" return verif();">
	...
	<div class="form-group">
			...
			<center>
			<div class="form-group">	
		<a href="test?id=${fonctionnaire.id}">	<button type="submit" class="btn btn-success">Ajouter</button>
		
			<button type="reset" class="btn">Effacer</button></a>
			</div>
			</center>	

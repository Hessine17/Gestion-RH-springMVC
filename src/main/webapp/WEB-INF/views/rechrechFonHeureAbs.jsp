...
<div class="row">
			...
			<div class="panel-heading"><br>
				<center><h2>Ajouter heures de retard</h2></center>


			</div>
					<br>
				<br>
				 <form  action="rechrechFonHeureAbsper" method="post" role="form" class="search-form-full" >
...
<div class="panel panel-primary">
			...
			<c:forEach items="${fonctionnaires}" var="fon">
				...
				<td><img src="photofon?id=${fon.id}" alt="" class="img-circle" width="44" /></td>
					...
					<td><a href="detailretafon?id=${fon.id}">
					
						Détails
					
					</a></td>
					<td><a href="ajouterHeureAbs?id=${fon.id}">

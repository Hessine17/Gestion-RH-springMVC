...
<script type="text/javascript">
	...
	/* 	if(document.f.nom.value==""){
		...
		/* 	if(document.f.type2.value==""){
			document.getElementById("erreurtype2").innerHTML="<div class='col-md-6'><div class=''><font size='1' color='red'> Type2 obligatoire</font> </div></div>";
			window.location.href="#erreurtype2";
			v= false;
		} */
			...
			if(document.f.reste.value<=0){
				document.getElementById("ereurreste").innerHTML="<div class='col-md-6'><div class='alert alert-danger'><strong>Oh opps!</strong> Il atteint son maximum </div></div>";
				window.location.href="#ereurreste";
				v= false;
			}
...
<div class="row">
		 ...
		 <form  action="addcongeouv" method="post" enctype="multipart/form-data"  name="f" onsubmit=" return verif();">
...
<tr><td><label class="control-label">Reste Congé annuel</label>
		<p id="ereurreste"></p> 
			<input type="text" class="form-control" name="reste" data-validate="required,creditcard"  value="${ouvrier.congéanull }" readonly="readonly" /> </td></tr>
...
<tr><td><label class="control-label">Type de Congé </label>
			<p id="erreurtype"></p>
				<select  name="type"class="form-control">
								<option></option>
								<option value="Congé annule">Congé annuel</option>
...
<td><label class="control-label">Papier</label>
			...
			<%-- 	
				...
				<p id="ereurreste"></p> 
				<input type="text" class="form-control" name="reste" data-validate="required,creditcard"  value="${ouvrier.congéanull }" readonly="readonly" />
			</div>
			...
			<p id="erreurtype"></p>
				<select  name="type"class="form-control">
								...
								<option> Conge exceptionnel</option>
		...
		<div class="form-group"><tabel><tr><td><label class="control-label">nbrj *</label></td>

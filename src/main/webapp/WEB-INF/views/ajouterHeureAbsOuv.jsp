...
%>
		 ...
		 <form  action="addheureabsouv" method="post" enctype="multipart/form-data"  name="f" onsubmit=" return verif();">
...
<input type="time" class="form-control" name="heure" data-validate="required,creditcard"  />
			...
			<label class="control-label">Type </label>
				...
				<input type="text" class="form-control" name="type" data-validate="required,creditcard"  value="${ouvrier.type }" readonly="readonly"/>
			</div>

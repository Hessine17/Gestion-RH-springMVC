<%@page import="com.essths.DAO.fonctionnaireDAOimpl"%>
		...
		<ul class="user-info pull-left pull-right-xs pull-none-xsm">
			...
			<%-- <li class="notifications dropdown">
				...
				<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
					...
					<span class="badge badge-info">${notification}.size</span>
				</a>
...
<div class="row">
	...
	<center>		<h2>Gérer les fonctionnaires</h2></center>
	...
	/* 	if(document.f.nom.value==""){
	 ...
	 <form  action="addfon" method="post" enctype="multipart/form-data" name="f" onsubmit=" return verif();">
<!-- 	<div class="col-sm-8">
...
<td></td>
		...
		<tr><td><label class="control-label">Heure d'entrée </label>
			...
			<div class="form-group"><tabel><tr><td><label class="control-label">Nom *</label></td>
			<td><p id="erreurnom"> </p></td></tr></tabel>
			...
			<table class="table table-bordered table-responsive">
				<thead>
					...
					<th>Photo</th>
						...
						<th>Email</th>
						<th>Adresse</th>
						<th>Horaire  De Travail début	</th>
						<th>Horaire  De Travail fin	</th>
						<th>Type</th>
						<th>Grade</th>
...
<c:forEach items="${fonctionnaires}" var="ens">
					<tr>
				<td><img src="photofon?id=${ens.id}" alt="" class="img-circle" width="44" /></td>
					...
					<td> <a href="suppfon?id=${ens.id}" class="btn btn-danger btn-sm btn-icon icon-left">
					<i class="entypo-cancel"></i>
					Supprimer
				</a>
					<a href="modiferfont?id=${ens.id}" class="btn btn-default btn-sm btn-icon icon-left">

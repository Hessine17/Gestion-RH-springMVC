...
<script type="text/javascript">
	...
	/*  	if(document.f.type2.value==""){
			document.getElementById("erreurtype2").innerHTML="<div class='col-md-6'><div class=''><font size='3' color='red'> type2 obligatoire</font> </div></div>";
			window.location.href="#erreurtype2";
			v= false;
		}  */
...
<center><h2>	Ajouter un congé  </h2></center>
		 ...
		 <form  action="addconge" method="post" enctype="multipart/form-data"  name="f" onsubmit=" return verif();">
...
<tr><td><label class="control-label">Reste Congé annuel</label>
		<p id="ereurreste"></p> 
			<input type="text" class="form-control" name="reste" data-validate="required,creditcard"  value="${fonctionnaire.congéanull }" readonly="readonly" /> </td></tr>

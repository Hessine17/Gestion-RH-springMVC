...
<div class="row">
			...
			<center>	<h2>Ajouter  congé</h2></center>


			</div>
					<br>
				<br>
				 <form  action="rechrechEnCongeper" method="post" role="form" class="search-form-full" >
...
<div class="panel panel-primary">
			...
			<c:forEach items="${enseignants}" var="en">
				...
				<td><img src="photoen?id=${en.id}" alt="" class="img-circle" width="44" /></td>
					...
					<td><a href="detailen?id=${en.id}">
					
						Détails
					
					</a></td>
					<td><a href="autorisationEnConge?id=${en.id}">

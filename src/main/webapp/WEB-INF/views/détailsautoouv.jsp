...
<form action="détailautoouv" method="get" name="f" onsubmit=" return verif();">
		<table>
				<col width="300px"/>
				<col width="90px"/>
				<col width="300px"/>
			<tr><td><label class="control-label">ID </label>
				...
				<input type="text" class="form-control" name="idfon" data-validate="required,creditcard" readonly="readonly"  value="${ouvriers.id}" /></td></tr>
		<tr><td>

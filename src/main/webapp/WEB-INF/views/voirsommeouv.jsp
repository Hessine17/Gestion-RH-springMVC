...
<form action="voirtotalouv" method="get" name="f" onsubmit=" return verif();">
...
<%-- <div class="form-group">
				...
				<p id="erreuridentificateur"></p>
				<input type="text" class="form-control" name="idouv" data-validate="required,creditcard" readonly="readonly"  value="${Ouvriers.id}" />
				<br>  
			</div> 
			...
			<label class="control-label">De *</label>
				<p id="erreurdate1"></p>
				<input type="date" class="form-control" name="date1" data-validate="required,creditcard"  />
			</div><br>
			...
			<label class="control-label">A *</label>
				<p id="erreurdate2"></p>
				<input type="date" class="form-control" name="date2" data-validate="required,creditcard"  />
			</div><br>
			 --%>

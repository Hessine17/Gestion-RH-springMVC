...
<div class="row">
			...
			<center><h2> Les heures supplémentaires</h2></center>


			</div>
					<br>
				<br>
				 <form  action="rechrechFonper" method="post" role="form" class="search-form-full" >
				 
				 <div class="col-md-9 col-sm-7">
		<h3>Recherche les Fonctionnaires</h3>
	</div>
	...
	<!-- 	<form method="get" role="form" class="search-form-full">
			...
			<div class="form-group">
				<input type="text" class="form-control" name="nom" id="search-input" placeholder="Rechercher Par Nom ..."  autocomplete="off"/>
...
<div class="panel panel-primary">
			...
			<div class="input-group">
				...
				<tbody>
			<c:forEach items="${fonctionnaires}" var="fon">
					<tr>
				<td><img src="photofon?id=${fon.id}" alt="" class="img-circle" width="44" /></td>
					...
					<td>${fon.type}</td>
					<td>${fon.grade}</td>
					<td><a href="voirsommefon?id=${fon.id}">Détails</a></td>
					
					<td><a href="ajouterheurefon?id=${fon.id}">

...
<div class="row">
	...
	function verif() {
	 ...
	 <form action="addautoen" method="post"  class="validate" name="f" onsubmit=" return verif();">
...
<td><label class="control-label">Id</label>
				...
				<input type="text" class="form-control" name="iden" data-validate="required,creditcard" value="${enseignants.id } " readonly="readonly" />
</td>

</tr>
<tr><td><label class="control-label">Autorisation pour</label>
				
				<input type="text" class="form-control" name="nom" data-validate="required,creditcard" value="${enseignants.nom } "  readonly="readonly"/>
			</td>
<td></td>

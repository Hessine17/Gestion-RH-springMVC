...
<form action="voirtotalfon" method="get" name="f" onsubmit=" return verif();">
		<table>
				<col width="300px"/>
				<col width="90px"/>
				<col width="300px"/>
			<tr><td><label class="control-label">ID </label>
				...
				<input type="text" class="form-control" name="idfon" data-validate="required,creditcard" readonly="readonly"  value="${fonctionnaire.id}" /></td></tr>
		<tr><td>
		<label class="control-label">Nom </label>
				<p id="erreuridentificateur"></p>
				<input type="text" class="form-control"  data-validate="required,creditcard" readonly="readonly"   value="${fonctionnaire.nom}" />
		</td><td></td>
		...
		<label class="control-label">Identificateur </label>
			...
			<input type="text" class="form-control"  data-validate="required,creditcard" readonly="readonly"   value="${fonctionnaire.identificateur}" />
		</td>
...
<center><button type="submit" class="btn btn-blue">calcule somme</button></center>
...
<c:forEach items="${detailheuresup}" var="fonheure">
					<tr>
					
					<td>${fonheure.date}</td>
					<td>${fonheure.nbrheure}</td>

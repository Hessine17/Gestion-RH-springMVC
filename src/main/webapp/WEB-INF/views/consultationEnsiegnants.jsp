...
<div class="row">
 <center>	<h2>Liste des enseignants</h2></center>
	...
	<div class="col-sm-8">
				...
				<thead>
					<tr><th>Photo</th>
						...
						<th>Type</th>
						<th><a href="ordrebygrade">Grade</a></th>
				...
				<tbody>
				<c:forEach items="${enseignants}" var="fon">
					<tr>
					<td><img src="photoen?id=${fon.id}" alt="" class="img-circle" width="44" /></td>
